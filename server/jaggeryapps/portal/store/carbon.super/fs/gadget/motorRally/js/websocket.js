...
function intializeWebsocketUrls(){
    ...
    wso2.gadgets.identity.getUsername(function(username) {
        ...
        $.getJSON("/portal/store/carbon.super/fs/gadget/motorRally/controllers/get_server_info.jag?username="+username, function (data) {
...
SpatialObject.prototype.stateIcon = function () {
    var iconUrl = "/portal/store/carbon.super/fs/gadget/motorRally/img/markers/object-types/"  + this.type.toLowerCase();
